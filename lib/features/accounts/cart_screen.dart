      ...
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              children: [
                ...
                _row(
                  'Барааны нийт дүн',
                  Text(
                    formatMnt(_subtotal, space: true),
                    style: moneyStyle(size: 11, weight: FontWeight.w600),
                  ),
                ),
                _row(
                  'Хүргэлтийн төлбөр',
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: moneyStyle(size: 11, color: AppColors.slate700),
                      ),
                      const SizedBox(width: 4),
                      StatusBadge(
          ...
          const InfoNote(
            ...
            text: 'Таны захиалга аав ээжийн зөвшөөрлөөр данснаас суутгагдана.',
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  formatMnt(item.price * item.quantity, space: true),
                  style: moneyStyle(
                    size: 12,
                    weight: FontWeight.w800,
                    color: AppColors.slate900,
